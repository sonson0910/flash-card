    ...
    <div className="max-w-2xl mx-auto flex flex-col items-center pt-8" aria-busy={loading}>
      ...
      {loading ? (
        ...
        <GsapEntrance
          ...
          role="alert"
          variant="result"
          className="w-full max-w-md rounded-[32px] border border-rose-300 bg-rose-50 p-7 text-center text-rose-900 shadow-xl focus:outline-none dark:border-rose-900 dark:bg-rose-950/30 dark:text-rose-100"
        >
          ...
          <button type="button" onClick={onGenerate} className="mt-6 inline-flex min-h-11 items-center gap-2 rounded-xl bg-rose-700 px-5 py-3 font-bold text-white transition-colors hover:bg-rose-800">
