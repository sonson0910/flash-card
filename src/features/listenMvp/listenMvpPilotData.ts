...
export const LISTEN_MVP_PILOT_LESSONS_DATA = [
  {
    clip: clipFor('break-the-news', 'media/listen-mvp/break-the-news.m4a', 733_106, 'voa-break-the-news', BREAK_THE_NEWS_SHA256, [
      ...
      cue('break-the-news', 'break-the-news-cue-7', 34_000, 39_100, "Budget cuts, there's not enough money for two."),
      cue('break-the-news', 'break-the-news-cue-8', 39_100, 43_100, 'But can I borrow that travel book?'),
      cue('break-the-news', 'break-the-news-cue-9', 43_100, 53_100, 'To break the news means to tell someone bad news, something that will make them upset or sad.'),
      cue('break-the-news', 'break-the-news-cue-10', 53_100, 60_000, 'Breaking the news can be a hard thing to do, and so can hearing about it.'),
    ]),
    ...
    comprehension: {
      ...
      options: ['Tell someone bad or upsetting news', 'Hide a newspaper', 'Fix a broken story'],
      answer: 'Tell someone bad or upsetting news',
    },
  },
  {
    clip: clipFor('on-the-ball', 'media/listen-mvp/on-the-ball.m4a', 733_022, 'voa-on-the-ball', ON_THE_BALL_SHA256, [
      ...
      cue('on-the-ball', 'on-the-ball-cue-5', 24_000, 30_000, 'Wow, you are on the ball! How did you do them so fast? Coffee!'),
      cue('on-the-ball', 'on-the-ball-cue-6', 30_000, 40_000, "Lots of coffee. Do you want some? I'll get it. I'd love more coffee. Thank you. Sure. But maybe not that much coffee."),
      cue('on-the-ball', 'on-the-ball-cue-7', 40_000, 48_000, 'Someone who is on the ball finishes work quickly and ahead of time.'),
      cue('on-the-ball', 'on-the-ball-cue-8', 48_000, 56_000, 'We can also say a person should get on the ball when they need to work faster or better.'),
    ]),
    ...
    comprehension: {
      ...
      options: ['Work quickly, well, or ahead of time', 'Slow and confused', 'Quiet and tired'],
      answer: 'Work quickly, well, or ahead of time',
    },
  },
  {
    clip: clipFor('fair-and-square', 'media/listen-mvp/fair-and-square.m4a', 733_123, 'voa-fair-and-square', FAIR_AND_SQUARE_SHA256, [
      ...
      cue('fair-and-square', 'fair-and-square-cue-2', 6_000, 15_000, 'We all like to be treated fairly. But what about being treated squarely?'),
      cue('fair-and-square', 'fair-and-square-cue-3', 15_000, 18_000, "Let's learn how to use the idiom fair and square."),
      cue('fair-and-square', 'fair-and-square-cue-4', 18_000, 23_000, 'Anna, where have you been? I lost you in the crowd.'),
      cue('fair-and-square', 'fair-and-square-cue-5', 23_000, 27_000, "I was playing games! I'm really good at carnival games!"),
      cue('fair-and-square', 'fair-and-square-cue-6', 27_000, 31_000, 'I see that! You really won a lot of stuffed animals.'),
      cue('fair-and-square', 'fair-and-square-cue-7', 31_000, 35_000, "Are you sure you didn't cheat? No!"),
      cue('fair-and-square', 'fair-and-square-cue-8', 35_000, 39_000, 'I won them all fair and square!'),
      cue('fair-and-square', 'fair-and-square-cue-9', 39_000, 43_000, "And they're all mine. All mine! Hahaha...!"),
      cue('fair-and-square', 'fair-and-square-cue-10', 46_000, 52_000, 'Fair and square describes winning something in an honest way and without any doubt.'),
      cue('fair-and-square', 'fair-and-square-cue-11', 52_000, 60_000, 'The expression is a fun one to say because it rhymes—fair and square!'),
    ]),
