...
export const LISTEN_PHRASE_CARDS = Object.freeze([
  {
    ...
    lexemeId: BREAK_THE_NEWS_LEXEME_ID,
  ...
  },
  {
    ...
    lexemeId: ON_THE_BALL_LEXEME_ID,
    lemma: 'on the ball',
    normalizedLemma: 'on the ball',
    language: 'en',
    phonetic: '',
    partOfSpeech: 'phrase',
    senseKey: 'on-the-ball',
    cefr: 'B1',
    tier: 'foundation',
    topics: ['Work'],
    skills: ['listening'],
  ...
  },
  {
    ...
    lexemeId: FAIR_AND_SQUARE_LEXEME_ID,
    lemma: 'fair and square',
    normalizedLemma: 'fair and square',
    language: 'en',
    phonetic: '',
    partOfSpeech: 'phrase',
    senseKey: 'fair-and-square',
    cefr: 'B1',
    tier: 'foundation',
    topics: ['Communication'],
    skills: ['listening'],
