...
const VOA_ATTRIBUTION = 'Voice of America Learning English';
const VOA_RIGHTS_URL = 'https://learningenglish.voanews.com/p/6861.html';
...
export const LISTEN_MVP_PILOT_REGISTRY: CatalogSourceAssetRegistryV1 = Object.freeze(
  parseCatalogSourceAssetRegistryV1({
    registryVersion: 1,
    assets: [
      source(
        'voa-break-the-news',
        'https://learningenglish.voanews.com/a/7949136.html',
        BREAK_THE_NEWS_SHA256,
        '2025-01-27',
      ),
      source(
        'voa-on-the-ball',
        'https://learningenglish.voanews.com/a/7990719.html',
        ON_THE_BALL_SHA256,
        '2025-03-03',
      ),
      source(
        'voa-fair-and-square',
        'https://learningenglish.voanews.com/a/7932782.html',
        FAIR_AND_SQUARE_SHA256,
        '2025-01-13',
      ),
    ],
  }),
...
const rawPilotLessons = [
  {
    ...
    chunk: chunkFor('break-the-news', 'break the news', 'voa-break-the-news', BREAK_THE_NEWS_SHA256),
    comprehension: {
  ...
  },
  {
    ...
    chunk: chunkFor('on-the-ball', 'on the ball', 'voa-on-the-ball', ON_THE_BALL_SHA256),
    comprehension: {
  ...
  },
  {
    ...
    chunk: chunkFor('fair-and-square', 'fair and square', 'voa-fair-and-square', FAIR_AND_SQUARE_SHA256),
    comprehension: {
...
const knownLexemeIds = new Set(rawPilotLessons.flatMap(lesson => lesson.chunk.lexemeIds));
...
export const LISTEN_MVP_PILOT_LESSONS: readonly ListenMvpLessonV1[] = Object.freeze(
  rawPilotLessons.flatMap(lesson => {
    try {
      return [parseListenMvpPilotLessonV1(lesson)];
    } catch {
      return [];
    }
  }),
...
export { VOA_ATTRIBUTION, VOA_RIGHTS_URL };
