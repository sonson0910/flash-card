        ...
        {analysis.syllables.map((syl, idx) => {
          ...
          return (
            <button
              ...
              className={`group relative flex min-h-11 min-w-11 touch-manipulation items-center justify-center gap-1.5 rounded-full border px-2.5 py-0.5 text-xs transition-[background-color,border-color,color,transform,box-shadow] duration-200 cursor-pointer ${
                isStressed
