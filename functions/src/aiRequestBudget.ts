export type VocabularyAiAction = 'word' | 'story' | 'translate' | 'tutor' | 'mnemonic' | 'extract' | 'dialogue';

export interface VocabularyAiBudget {
  scope: 'ai-card' | 'ai-story' | 'ai-translate' | 'ai-tutor' | 'ai-mnemonic' | 'ai-extract' | 'ai-dialogue';
  maximum: number;
  message: string;
}
